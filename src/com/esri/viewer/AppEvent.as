...
public class AppEvent extends Event
{
	...
	/**
	 * 通知MapManager开始配置底图，王红亮，2012-8-31
	 */
	public static const START_LOAD_BASEMAPS:String = "startLoadBasemaps";
	...
	/**
	 * 各个widgetContainer模块已经加载并创建完成。
	 * 王红亮，2012-01-04
	 */
	public static const WIDGET_CONTAINER_LOADED:String = "widgetContainerLoaded";
	
	/**
	 * 各个widgetContainer借入偿还。
	 * var data:Object{type:"borrow/payBack", //借入或偿还
	 * 			index:int, //在SplitManager中的序号
	 * 			container:IVisibleElement //容器实例
	 * }
	 * 王红亮，2012-01-12
	 */
	public static const WIDGET_CONTAINER_CHECK:String = "WidgetContainerCheck";
	/**
	 * 各个widgetContainer由不见变为可见。
	 * var data:Object{type:"show/hide", //显示或隐藏
	 * 			index:int, //在SplitManager中的序号
	 * 			container:IVisibleElement //容器实例
	 * }
	 * 王红亮，2012-01-12
	 */
	public static const WIDGET_CONTAINER_VISIBLE:String = "WidgetContainerVisible";
	/**
	 * 通知改变widgetContainer的状态 such as close, min and max
	 * var data:Object {
	 *    id: id, //as Number
	 *    state: stateString //as String
	 * }
	 * AppEvent.publish(AppEvent.WIDGET_CONTAINER_CHANGE_STATE, data);
	 * 王红亮，2012-7-24
	 */
	public static const WIDGET_CONTAINER_CHANGE_STATE:String = "widgetContainerChangeState";
	
	/**
	 * 对查询的结果进一步处理，如最近路径或缓冲�?
	 * var data:Object{
	 * widgetId:目的地widgetId
	 * name:当前操作目标的名称
	 * geometry:当前目标的几何形状
	 * }
	 * 王红亮，2011-04-07
	 */
	public static const POST_PROCESS:String = "postProcess";
	
	/**
	 * Widget自身及其子控件创建完成，并且添加至显示列表之中，即widgetContainer之中
	 * var data:Object{widgetId:刚刚创建完成的widgetId}
	 * 王红亮，2012-02-08
	 */
	public static const WIDGET_CREATION_COMPLETE:String = "widgetCreationComplete";
	
	/**
	 * 通知各个模块，用户已经退出登录
	 * 王红亮，2012-4-10
	 */
	public static const USER_LOG_OFF:String = "userLogOff";
	
	/**
	 * 用户登陆
	 * 温杨彪，2012-8-3
	 **/
	public static const USER_LOG_IN:String = "userLogIn";
	/**
	 * 模块间请求当前地图组id的请求与响应
	 * 王红亮，2013-3-11
	 */
	public static const CURRENT_MAP_GROUP_REQUEST:String = "currentMapGroupRequest";
	public static const CURRENT_MAP_GROUP_RESPONSE:String = "currentMapGroupResponse";
